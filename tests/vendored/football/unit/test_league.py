...
from fantasy_yolo.espn.football import League, BoxPlayer
from fantasy_yolo.espn.requests.constant import FANTASY_BASE_ENDPOINT
from fantasy_yolo.espn.football.helper import (
...
class LeagueTest(TestCase):
    def setUp(self):
        ...
        with open('tests/vendored/football/unit/data/league_2018_data.json') as data:
            self.league_data = json.loads(data.read())
        with open('tests/vendored/football/unit/data/league_draft_2018.json') as data:
            self.draft_data = json.loads(data.read())
        with open('tests/vendored/football/unit/data/league_players_2018.json') as data:
            self.players_data = json.loads(data.read())
        with open('tests/vendored/football/unit/data/league_2019_playerCard.json') as data:
            self.player_card_data = json.loads(data.read())
        with open('tests/vendored/football/unit/data/pro_schedule_2024.json') as data:
    ...
    def test_load_roster_week(self, m):
        ...
        with open('tests/vendored/football/unit/data/league_roster_week1.json') as f:
    ...
    def test_get_scoreboard(self, m):
        ...
        with open('tests/vendored/football/unit/data/league_matchupScore_2018.json') as f:
            data = json.loads(f.read())
    ...
    #     with open('tests/vendored/unit/data/league_boxscore_2018.json') as f:
    #         data = json.loads(f.read())
    ...
    def test_recent_activity(self, m):
        ...
        with open('tests/vendored/football/unit/data/league_recent_activity_2019.json') as f:
            data = json.loads(f.read())
