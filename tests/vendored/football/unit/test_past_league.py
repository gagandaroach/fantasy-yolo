...
class LeaguePastTest(TestCase):
    def setUp(self):
        ...
        with open('tests/vendored/football/unit/data/league_2015_data.json') as data:
            self.league_data = json.loads(data.read())
        with open('tests/vendored/football/unit/data/league_draft_2015.json') as data:
            self.draft_data = json.loads(data.read())
        with open('tests/vendored/football/unit/data/league_players_2015.json') as data:
    ...
    def test_get_scoreboard(self, m):
        ...
        with open('tests/vendored/football/unit/data/league_matchupScore_2015.json') as f:
