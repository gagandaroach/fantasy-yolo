...
from fantasy_yolo.espn.basketball.activity import Activity
from fantasy_yolo.espn.basketball.constant import ACTIVITY_MAP, POSITION_MAP
...
class ActivityTest(TestCase):
    ...
    def test_activity_init_with_moved_no_include(self):
        ...
        activity = Activity(data, self.player_map, self.get_team_data, include_moved=False)
    ...
    def test_activity_init_with_moved_include(self):
        ...
        activity = Activity(data, self.player_map, self.get_team_data, include_moved=True)
