...
from fantasy_yolo.espn.basketball.league import League
from fantasy_yolo.espn.basketball.team import Team
from fantasy_yolo.espn.basketball.matchup import Matchup
...
class LeagueTest(TestCase):
    ...
    def test_league_init_no_fetch(self):
        ...
        with mock.patch('fantasy_yolo.espn.basketball.league.BaseLeague.__init__', return_value=None):
    ...
    def test_league_init_with_espn_s2_swid(self):
        ...
        with mock.patch('fantasy_yolo.espn.basketball.league.BaseLeague.__init__', return_value=None) as mock_init:
