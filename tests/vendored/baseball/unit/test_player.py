...
from fantasy_yolo.espn.baseball.constant import DEFAULT_POSITION_MAP, POSITION_MAP, STAT_SPLIT_MAP
...
class PlayerMiscTest(TestCase):
    ...
    def test_pro_team_mapped(self):
        from fantasy_yolo.espn.baseball.constant import PRO_TEAM_MAP
