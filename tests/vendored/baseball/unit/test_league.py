...
from fantasy_yolo.espn.baseball import League
from fantasy_yolo.espn.baseball.activity import Activity
from fantasy_yolo.espn.baseball.box_score import RotoBoxScore
from fantasy_yolo.espn.baseball.matchup import Matchup
from fantasy_yolo.espn.baseball.player import Player
from fantasy_yolo.espn.baseball.constant import POSITION_MAP
...
class BoxScoresTest(TestCase):
    ...
    @mock.patch('fantasy_yolo.espn.baseball.league.League._get_pro_schedule', return_value={})
    @mock.patch.object(EspnFantasyRequests, 'league_get')
...
class RefreshTest(TestCase):
    ...
    @mock.patch('fantasy_yolo.espn.baseball.league.BaseLeague._fetch_league')
