...
from fantasy_yolo.espn.baseball.team import Team
...
def _make_team(data=None):
    ...
    roster = {'entries': []}
    schedule = []
    with mock.patch('fantasy_yolo.espn.baseball.team.Player'), \
         mock.patch('fantasy_yolo.espn.baseball.team.Matchup'):
