...
from fantasy_yolo.espn.base_league import BaseLeague
from fantasy_yolo.espn.hockey import League as HockeyLeague, Team
from fantasy_yolo.espn.requests.espn_requests import EspnFantasyRequests
...
class BaseLeagueTest(TestCase):
    ...
    def test_base_league_fetch_players(self, mock_get_players):
        with open('tests/vendored/hockey/unit/data/player_data.json') as data:
    ...
    def test_base_league_fetch_schedule(self, mock_get_pro_schedule):
        with open('tests/vendored/hockey/unit/data/pro_schedule.json') as data:
...
class HockeyLeagueTest(BaseLeagueTest):
    ...
    def test_league_scoreboard(self, mock_get_league_request, mock_league_get_request, mock_league_draft):
        with open('tests/vendored/hockey/unit/data/matchup_data.json') as file:
    ...
    def test_league_free_agency(self, mock_get_league_request, mock_league_get_request, mock_league_draft):
        with open('tests/vendored/hockey/unit/data/free_agent_data.json') as file:
    ...
    def test_league_recent_activity(self, mock_get_league_request, mock_league_get_request, mock_league_draft):
        with open('tests/vendored/hockey/unit/data/recent_activity_data.json') as file:
    ...
    def test_league_box_scores(self, mock_get_league_request, mock_league_get_request, mock_league_draft):
        mock_league_draft.return_value = {}
        with open('tests/vendored/hockey/unit/data/box_score_data.json') as file:
