...
from fantasy_yolo.espn.wbasketball.player import Player
from fantasy_yolo.espn.wbasketball.constant import POSITION_MAP, PRO_TEAM_MAP, STATS_MAP


def _make_player_data(full_name='Test Player', player_id=1234, default_position_id=1,
                      lineup_slot_id=0, eligible_slots=None, pro_team_id=3,
                      acquisition_type='DRAFT', injury_status='ACTIVE', stats=None,
                      player_extras=None):
...
class PlayerTest(TestCase):
    ...
    def test_player_basic_init(self):
        ...
        data = _make_player_data(full_name='Breanna Stewart', player_id=1001, default_position_id=2)
